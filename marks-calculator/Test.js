...
export function init() {
    ...
    function render() {
        ...
        totalCheckbox.addEventListener('change', () => toggleTotalSubscription(totalCheckbox.checked));
        ...
        avgCheckbox.addEventListener('change', () => toggleAverageSubscription(avgCheckbox.checked));
